...
// Initial products data - gadgets and devices
let products = [
  {
    id: '1',
    name: 'iPhone 15 Pro',
...
app.get('/api/products', (req, res) => {
  ...
  // Apply color filter (searches in colors array)
  if (color) {
...
app.listen(PORT, () => {
  ...
  console.log(
    'Test it by opening http://localhost:3001/api/products in your browser.'
  );
});
